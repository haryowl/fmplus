...
export function liveHref(search: string): string {
  return withSearch("/live", search);
}
...
export function routePlanHref(search: string): string {
  return withSearch("/route", search);
}
